...
template <typename Type>
void Simple_tree<Type>::breath_first_traversel()
{
    Queue<Simple_tree*> q;
    q.push(this);
    while (!q.empty())
...
int main()
{
    Simple_tree<char>* tree = new Simple_tree<char>('T');
    tree->insert('o');
    tree->insert('u');
    Simple_tree<char>* tree2 = new Simple_tree<char>('s');
    tree2->insert('e');
    tree2->insert('e');
    Simple_tree<char>* tree3 = new Simple_tree<char>('f');
    tree->attach(tree2);
    tree2->attach(tree3);
    cout << "\nDEPTH FIRST SEARCH : ";
    tree->depth_first_traversel();
    cout << "\nBREATH FIRST SEARCH : ";
    tree->breath_first_traversel();
    return 0;
}